  ...
  return (
    <FocusedLayout backTo="/">
      <div style={{
        ...
        <h1 style={{ color: '#1a1a2e', fontSize: '2.2rem', marginBottom: '0.5rem' }}>Welcome Back</h1>
        <p style={{ color: '#666' }}>Log in to see your interview history.</p>
        ...
        <div style={{
          ...
          <p style={{ textAlign: 'center', marginTop: '1rem', fontSize: '0.9rem' }}>
            Don't have an account? <Link to="/register" style={{ color: '#5b3df5', fontWeight: 'bold' }}>Sign up</Link>
          </p>
        </div>
      </div>
    </FocusedLayout>
