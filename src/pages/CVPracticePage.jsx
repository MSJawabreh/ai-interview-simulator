...
return (
	<FocusedLayout backTo="/">
		<div style={{
			...
			<h1 style={{ color: '#1a1a2e', fontSize: '2.2rem', marginBottom: '0.5rem' }}>CV-Based Interview</h1>
			<p style={{ color: '#666', maxWidth: '400px' }}>
				Upload your CV and get interview questions based on your actual projects and experience.
			</p>
			...
			<div style={{
				...
				<label style={{ fontWeight: 'bold', display: 'block', marginBottom: '0.3rem' }}>Upload your CV (PDF or DOCX)</label>
				<input
					type="file"
					accept=".pdf,.docx"
